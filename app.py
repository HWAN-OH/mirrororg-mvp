...
TRANSLATIONS = {
    "ko": {
        ...
        "sidebar_info_text": "1. 팀의 대화 기록 파일(예: 카카오톡/슬랙 .txt)을 업로드하세요.\n2. '분석 리포트 생성하기' 버튼을 클릭하세요.\n3. AI가 생성한 1페이지 진단 리포트를 받아보세요.",
        ...
        "sidebar_copyright": "© 2025 MirrorMind, Inc. All Rights Reserved.",
        "main_title": "🧠 MirrorOrg 조직 진단 리포트",
        "main_subtitle": "AI 조직 심리 분석가가 대화 기록을 바탕으로 팀의 소통 패턴과 시스템 리스크를 진단합니다.",
        "uploader_label": "분석할 대화 파일을 업로드하세요. (카카오톡/슬랙 .txt 파일 권장)",
    ...
    "en": {
        ...
        "uploader_label": "Upload a chat file to analyze. (KakaoTalk/Slack .txt recommended)",
