...
(Summarize the team's greatest systemic strengths and risks and add brief recommendations.)
...
def call_gemini_api(prompt: str, chat_log: str, is_json_output: bool) -> dict | list | str | None:
    ...
    try:
        ...
        if not response.parts:
            return {"error": "API response was blocked."} if is_json_output else "## Analysis Failed\n\nAPI response was blocked."
